...
The 1200×630 social preview in `public/assets/social-card.jpg` is a centered crop of that same original hero source. The SVG favicon is a hand-authored reduction of the repository’s envelope-and-seal icon. The 180px touch icon is resized from that original icon; no third-party artwork is used.
